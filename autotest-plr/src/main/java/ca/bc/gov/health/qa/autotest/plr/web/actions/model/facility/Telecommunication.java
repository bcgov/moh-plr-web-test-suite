...
public class Telecommunication {
	...
	@Override
	public int hashCode() {
		return Objects.hash(areaCode, dataOwnerCode, dataSource, dbCreated, dbExpired, effectiveFrom, effectiveTo,
				endReason, extension, number, purpose, type);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(areaCode, other.areaCode) && Objects.equals(dataOwnerCode, other.dataOwnerCode)
	...
	public Telecommunication(JSONObject jsonData) {
		...
		if (!jsonData.isNull("Area Code"))
			this.areaCode = jsonData.getString("Area Code");
		if (!jsonData.isNull("Extension"))
			this.extension = jsonData.getString("Extension");
	...
	public Telecommunication(LinkedHashMap<String, String> map) {
		...
		assertNotNull(map.get("Number"));
		this.number = map.get("Number");
		
		this.areaCode = map.get("Area Code") == null ? null : map.get("Area Code");
		this.extension = map.get("Extension") == null ? null : map.get("Extension");
