...
import ca.bc.gov.health.qa.autotest.plr.web.tests.types.ElectronicAddressType;
import ca.bc.gov.health.qa.autotest.plr.web.tests.types.IdentifierTypeName;
import ca.bc.gov.health.qa.autotest.plr.web.tests.types.RelatedProviderIdentifierType;
import ca.bc.gov.health.qa.autotest.plr.web.tests.types.RelationshipType;
import ca.bc.gov.health.qa.autotest.plr.web.tests.types.TelecommunicationType;
