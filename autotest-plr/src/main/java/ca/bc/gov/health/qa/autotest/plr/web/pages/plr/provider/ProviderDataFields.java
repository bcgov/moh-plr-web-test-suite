...
public class ProviderDataFields
{
    ...
    static
    {
        ...
        map.put(ProviderSection.IDENTIFIERS,                 List.of("Type", "Data Owner Code"));
        ...
        map.put(ProviderSection.PROVIDER_RELATIONSHIPS,      List.of("Relationship Type", "Related Provider Identifier"));
